  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 pt-24 overflow-hidden">
        ...
        {/* HERO SECTION */}
        <section id="home" className="min-h-dvh flex flex-col justify-center relative px-6 py-12">
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-20 order-2 lg:order-1">
              ...
              <h1 className="text-white font-display text-6xl sm:text-[5rem] lg:text-[6rem] leading-[0.85] drop-shadow-[4px_4px_0px_#000]">
                PORT<br />
            ...
            <div className="relative order-1 lg:order-2 flex justify-center items-center h-full min-h-[500px]">
              ...
              <div
                className="relative z-10 will-change-transform md:animate-none animate-float-3d"
          ...
          <div className="relative inline-block group">
            ...
            <div className="relative bg-white border-4 border-black p-12 md:p-20 shadow-[12px_12px_0px_rgba(255,215,0,1)]">
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-center">
                <a
                  href="mailto:islamsairaj9@gmail.com?subject=Join%20The%20Team"
